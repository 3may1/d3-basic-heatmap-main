...
let height = parseInt(d3.select("#svg-container").style("height")) - 150;
...
d3.csv("data/temperature-anomaly-data.csv")
  .then((raw_data) => {
    ...
    legendRects = svg
      ...
      legendRects.on("click", function(event, d) {
        rects.classed("faded", rect => rect.avg !== d);
    });
...
window.addEventListener("resize", () => {
  ...
  height = parseInt(d3.select("#svg-container").style("height")) - 150;
